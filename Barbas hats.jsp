<%-- 
    Document   : Barbas hats
    Created on : 6/12/2024, 09:04:18 PM
    Author     : gioca
--%>
...
<head>
    ...
    <title>Catálogo - Jarillo Hats</title>
    <style>
        ...
        <%
            ...
            try {
                ...
                stmt = conn.createStatement();
                 // Filtrar productos con visible_en_barbas = TRUE
                String sql = "SELECT id, nombre, imagen_url, precio FROM productos WHERE visible_en_barbas = TRUE";
