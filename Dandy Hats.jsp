<%-- 
    Document   : Dandy Hats
    Created on : 7/12/2024, 04:04:28 PM
    Author     : gioca
--%>
...
<head>
    ...
    <title>Catálogo - Dandy Hats</title>
    <style>
    ...
    <div class="product-container">
        <%
            ...
            try {
                ...
                // Modificación aquí: Filtrar productos con visible_en_dandy = TRUE
                String sql = "SELECT id, nombre, imagen_url, precio FROM productos WHERE visible_en_dandy = TRUE";
