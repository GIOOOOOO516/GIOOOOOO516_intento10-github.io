...
<%-- 
    Document   : ThirtyOne
    Created on : 7/12/2024, 04:05:11 PM
    Author     : gioca
--%>
...
<head>
    ...
    <title>Catálogo - Thirty One</title>
    <style>
    ...
    <div class="product-container">
        <%
            ...
            try {
                ...
                // Filtramos los productos para que solo se muestren los que tengan visible_en_thirty_one = TRUE
                String sql = "SELECT id, nombre, imagen_url, precio FROM productos WHERE visible_en_thirty_one = TRUE";
