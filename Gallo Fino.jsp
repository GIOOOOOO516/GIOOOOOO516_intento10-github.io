<%-- 
    Document   : Gallo Fino
    Created on : 7/12/2024, 04:04:52 PM
    Author     : gioca
--%>
...
<head>
    ...
    <title>Catálogo - Gallo Fino</title>
    <style>
    ...
    <div class="product-container">
        <%
            ...
            try {
                ...
                // Filtramos los productos para que solo se muestren los que tengan visible_en_gallo_fino = TRUE
                String sql = "SELECT id, nombre, imagen_url, precio FROM productos WHERE visible_en_gallo_fino = TRUE";
