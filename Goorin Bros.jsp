<%-- 
    Document   : Goorin bros
    Created on : 7/12/2024, 03:39:32 PM
    Author     : gioca
--%>
...
<head>
    ...
    <title>Catálogo - Goorin Bros</title>
    <style>
        /* Los mismos estilos que en Barbas hats.jsp */
        body {
    ...
    <div class="product-container">
        <%
            ...
            try {
                ...
                // Filtrar productos con visible_en_goorin = TRUE
                String sql = "SELECT id, nombre, imagen_url, precio FROM productos WHERE visible_en_goorin = TRUE";
